...
import GuideCard from '@/features/guide/components/GuideCard/GuideCard';
import { GuideListItem } from '@/features/guide/types';
import { useGetGuides, useDeleteGuide } from '@/features/guide/hooks/useGuideApi';
import {
  GuidesPageHeader,
  GuidesOwnershipTabs,
  GuidesFilters,
...
} from '@/features/guide/guide-list/components';
