...
/**
 * Bible queries: single module for all query hooks in this domain.
 */
...
export function useBookChapterInfo(
  bookName: string,
  ...
  return useQuery({
    ...
    queryFn: () =>
      BibleApiService.fetchBookChapterInfo(bookName, chapterNumber),
